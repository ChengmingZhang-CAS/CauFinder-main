...
def plot_3d_state_transition(adata, sample_indices=None, use_pca=True, concat_pca=True, feature1=None, feature2=None,
                             n_components=2, max_samples=10, smooth=1, draw_contours=True, add_key=None,
                             elev=30, azim=30, save_path=None):
    """
    ...
    for sample_idx in sample_indices:
        ...
        ax.view_init(elev=elev, azim=azim)  # Adjust the elevation and azimuth angles as needed
        if draw_contours:
        ...
        if save_path is not None:
            ...
            plt.savefig(os.path.join(save_path, f'state_transition_{sample_idx}_{key}.pdf'), dpi=300)
        plt.show()
